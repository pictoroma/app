...
type ServerContextValue = {
  ...
  acceptInvitation: (invitation: string, username: string, secret: string, name?: string) => Promise<void>;
}
...
const ServerProvider: React.FC = ({ children }) => {
  ...
  const acceptInvitation = useCallback(
    async (invitation: string, username: string, secret: string, name?: string) => {
  ...
  return (
    <ServerContext.Provider value={{ ...context, pushToken, logout, login, acceptInvitation }}>
      {children}
